...
#endif  //  #if (THERMISTORHEATER == 1) || (THERMISTORBED == 1) //100k bed thermistor
...
#endif  //  #if (THERMISTORHEATER == 2) || (THERMISTORBED == 2) //200k bed thermistor verified by arcol
...
#endif  //  #if (THERMISTORHEATER == 3) || (THERMISTORBED == 3) //mendel-parts
...
#endif  //  #if (THERMISTORHEATER == 4) || (THERMISTORBED == 4) //10k thermistor
...
#endif  //  #if (THERMISTORHEATER == 5) || (THERMISTORBED == 5) //100k ParCan thermistor (104GT-2)
...
#endif  //  #if (THERMISTORHEATER == 6) || (THERMISTORBED == 6) // 100k Epcos thermistor
...
#endif  //  #if (THERMISTORHEATER == 7) || (THERMISTORBED == 7) // 100k Honeywell 135-104LAG-J01


#if (THERMISTORHEATER == 8) || (THERMISTORBED == 8) // 100k V3 Thermistor as per June 2017 firmware update
#define NUMTEMPS_8 100
...
#endif  //  #if (THERMISTORHEATER == 8) || (THERMISTORBED == 8) // 100k V3 Thermistor 
